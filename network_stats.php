...
// Initialize arrays for 15 levels
$level_counts = array_fill(1, 15, 0);
$level_roi = array_fill(1, 15, 0);
$level_residual = array_fill(1, 15, 0);
$level_faststart = array_fill(1, 15, 0);
$level_withdrawal = array_fill(1, 15, 0);
$level_volume = array_fill(1, 15, 0);
    ...
    <main class="flex-1 overflow-y-auto p-8">
        <div class="max-w-[90rem] mx-auto space-y-10">
            ...
            <header>
                ...
                <p class="text-gray-500 text-sm">Real-time statistics of your 15-level organization.</p>
            </header>
